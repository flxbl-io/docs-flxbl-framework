...
The first three modular principles are about  _**cohesion**_, they tell us what to put inside packages:
...
<figure><img src="../../.gitbook/assets/image (3).png" alt=""><figcaption><p>Package C with a dependency cycle</p></figcaption></figure>
